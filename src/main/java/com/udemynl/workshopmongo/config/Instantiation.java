package com.udemynl.workshopmongo.config;
...
import com.udemynl.workshopmongo.dto.AuthorDTO;
import com.udemynl.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveita ai", sdf.parse("22/03/2018"), new AuthorDTO(bob));
